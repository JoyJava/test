...
public class EncrypDES3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] base64 = Base64.getEncoder().encode(encontent);

        System.out.println(new String(base64));
        System.out.println(encontent.length);
        System.out.println(Base64.getDecoder().decode(new String(base64)));
        ...
        System.out.println(String.format("%s_%s", 111, "bbb"));
    }
